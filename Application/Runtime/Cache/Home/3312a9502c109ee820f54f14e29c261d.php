...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/ttweibo/Public/Css/sech_user.css" />
                    ...
                    <ul>
                        <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                            <dl class='list-left'>
                                <dt>
                                <img src="
                                <?php if($v["face80"]): ?>/ttweibo/Uploads/Face/<?php echo ($v["face80"]); ?>
                                <?php else: ?>
                                /ttweibo/Public/Images/noface.gif<?php endif; ?>" width='80' height='80'/>
                                </dt>
                                <dd>
