...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/ttweibo/Public/Css/edit.css" />
        ...
        <script type="text/javascript" src="/ttweibo/Public/Js/city.js"></script>
        <script type="text/javascript" src="/ttweibo/Public/Js/edit.js"></script>
        ...
        <script type='text/javascript'>
            ...
            var address = "<?php echo ($user["location"]); ?>";//js 中无法解析模板
...
<!--==========创建分组==========-->
            ...
            <div id='right'>
                ...
                <div class='form hidden'>
                    <form action="<?php echo U('editFace');?>" method='post'>
                        <div class='edit-face'>
                            <img src="
                            <?php if($user["face180"]): ?>/ttweibo/Uploads/Face/<?php echo ($user["face180"]); ?>
                            <?php else: ?>
                            /ttweibo/Public/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
                            <p>
        ...
        <div id="bottom">
            <div id="copy">
                <div>
                    <p>
                    版权所有：天天微博 京ICP备10027771号-1 站长统计 All rights reserved, gmyboy.com services for shanghai 2008-2015
                    </p>
                </div>
            </div>
        </div>
